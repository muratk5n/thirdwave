...
```text
Date
2021-10-11    94.320000
2021-10-12    94.519997
2021-10-13    94.080002
2021-10-14    93.947998
Name: Adj Close, dtype: float64
[ 80.70110347 111.27964481]
```
...
```python
nnimport pandas as pd, datetime, time as timelib
import urllib.request as urllib2, io
end = datetime.datetime.now()
