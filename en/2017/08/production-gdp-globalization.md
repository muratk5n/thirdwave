...
I replicated Hidalgo's research [here](hidalgo.md), data, Python code
...
[From *The Atlas of Economic Complexity*] "The amount of knowledge
that is required to make a product can vary enormously from one good
to the next. Most modern products require more knowledge than what a
single person can hold. [..] Accumulating productive knowledge is
...
amount of course) product X and Y, because IMO only then can a third
