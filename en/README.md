...
Perhaps US wanted to preemp more RU presence in EastMed, now more
likely if allied with TR, and TR itself so Greece was courted for US
mil presence. There is now the Alexandroupoli port deploy, right near
Dardanelles, there is Volos, Skyros, Chalkidona. US was already
present in Souda (Crete), one report says now there are plans for a
second base. 'merica everywhere. Like Coca-Cola.
