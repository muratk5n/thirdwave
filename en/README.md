...
should allow new ways of working. Linux wasn't built bcz people could
"chat" overseas or "Zoom" (that tech didn't even exist). The project
(on top of Linus' leadership) was made possible through async concepts
such as the email, and shared code repos, and the patch file. 
