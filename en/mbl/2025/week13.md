...
optional mode, it’s just the way that Signal works. Every message,
every call, every time. Signal is independent and not for profit; a
different kind of tech from a different kind of organization"
...
addition to regular formal audits. We also constantly monitor
security@signal.org for any new reports, and we act on them with
quickness while also working to protect the people who rely on us from
outside threats like phishing with warnings and safeguards.

This is why Signal remains the gold standard for private, secure
communications"

---

Great line from the movie *Slumberland*: "My dad said schools are
basically prisons. They keep kids locked up physically and mentally,
prepare them for jobs that are also basically prisons, until they
retire and go to a nursing home. Their final prison"

---

Power Magazine: "BASF has commissioned that country’s largest proton
exchange membrane (PEM) electrolyzer.  The company said the 54-MW
facility will have an annual capacity of as much as 8,000 metric tons
of hydrogen. The electrolyzer is located at BASF’s Ludwigshafen
site. It is designed to produce zero-carbon hydrogen, using
electricity from renewable energy resources, with capacity to supply
the main plant at the site with up to one metric ton of chemical
feedstock each hour"

---

*Fight Or Flight*, they overdid the action near the end. A little
copycatting from *Bullet Train*. But it gets a C+. *Operation Fortune:
Ruse de Guerre*, fine too (same lead actor).

---

The TR opposition likely realized they made a mistake in the earlier
prez election. There were a lot of chefs in the kitchen then, settling
on a presidential candidate took a while, though many favored Istanbul
mayor Ekrem Imamoglu the decision wasn't clear cut. So when lawfare
was unleashed on him, just like today, the mayor was one of the many
candidates, the opposition sort of moved on to other candidates and
ultimately chose a lame guy (and lost).

Now oppo realized its mistake, they chose Imamoglu early, likely
expecting an undemocratic lawfare attack again, but when it arrived
this time they circled the wagons around him, making the fight about
EI and indirectly about democracy. If they insist on sticking with the
mayor they will be performing a boycott of sorts.

---

Politico: "Waltz at another point claimed he had never met Goldberg,
hours before a reporter unearthed a picture on social media of the two
men standing next to each other during a 2021 event at the French
Embassy."

---

Sometimes even potus can direct you to leak.. Party affiliation does
not match sure but some stuff might spin better if it comes from a Dem
dickbag like Goldberg.

---

Waltz could have added Goldberg to contact his list preparing to leak
to him later. Journos get those tidbits "from an unnamed official in
the administration" all the time don't they?. But then Waltz was
confused that day while creating the group, invited Goldberg by
mistake thinking he was someone else. It is possible.

---

Good timing for them.. DJT's Canada attacks helped libs there, before
econ gets any worse this is the right time for libs to capitalize on
the sentiment while it is fresh on the voters' minds. In terms of
governance, makes sense, new guy wants a mandate.

Politico: "Trump vs. Canada: Prime Minister Carney calls snap election
to take on president"

---

Foreign Policy: "On Tuesday, March 18, the German parliament ended the
country’s economic Sonderweg, or 'unique path.' On that day,
two-thirds of members voted for a far-reaching change of the fiscal
constitution. Technically, the debt brake—Germany’s constitutionally
codified fiscal rule—is still in place. But from now on, defense
expenditures exceeding 1 percent of GDP will be exempted from the
deficit ceiling; infrastructure and climate related expenditures can
be financed from a special fund, which is also exempted from the debt
brake; and states also get additional fiscal space"

---

TASS: "Western companies' return to Russia may be difficult if they
armed Ukraine"

---

Businessline: "India’s first hydrogen fuel cell train set likely to be
rolled out from ICF in April-May.. A pilot project on the Jind–Sonipat
section of Northern Railway will convert a 1200 KW DEMU into a
hydrogen fuel-cell-based Distributed Power Rolling Stock, thus
producing zero emissions"

---

IEEE Spectrum: "[2024/12] After a half-century hiatus, thorium has
returned to the front lines of nuclear power research as a source of
fuel. In 2025, China plans to start building a demonstration
thorium-based molten-salt reactor in the Gobi Desert. The 10-megawatt
reactor project, managed by the Chinese Academy of Sciences’ Shanghai
Institute of Applied Physics (SINAP), is scheduled to be operational
by 2030, according to an environmental-impact report released by the
Academy in October. The project follows a 2-MW experimental version
completed in 2021 and operated since then"
